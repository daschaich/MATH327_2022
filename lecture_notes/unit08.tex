...
Let's begin by considering non-relativistic particles of the sort we previously analyzed in \secref{sec:regulate}.
...
This factor of $2$ has a different origin compared to the double degeneracy discussed for photons in \secref{sec:photon}.
...
% TODO: Low temperatures provide a significant simplification, which is why we only consider that regime here...
% ------------------------------------------------------------------
...
In analogy to the Planck spectrum we derived for the photon gas in \secref{sec:planck}, we first express the particle number density as an integral over energies,
\begin{equation*}
