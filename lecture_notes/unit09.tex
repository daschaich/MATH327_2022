...
\renewcommand{\moddate}{Last modified 5 May 2022}
...
Breaking up the two terms in the exponential gives us
\begin{equation*}
  C_p(\be) = \left(\cosh \be \sinh \be\right)^{1 / 2} \exp\left[-\frac{1}{2} \stw_j \stw_k \log \sqrt{\tanh \be}\right].
\end{equation*}
