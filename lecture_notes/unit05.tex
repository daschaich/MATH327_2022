...
\renewcommand{\moddate}{Last modified 20 Feb.~2022}
...
Last week we defined the pressure in the canonical ensemble as the thermodynamic response of the internal energy to an isentropic change in the volume (\eq{eq:pressure}).
...
\TODO{For reversible thermodynamic cycles...}
\begin{shaded}
