...
\renewcommand{\moddate}{Last modified 27 Jan.~2022}
...
As an example to illustrate the applicability of the central limit theorem even for a modest $N = 5$, consider the roulette wheel discussed in \secref{sec:prob}.
...
\begin{align*}
  ...
  \vev{r^2} & = Np(Np + q).
\end{align*}
Plugging these results into \eq{eq:RWmoments}, we have:
\begin{mdframed}
  $\vev{x}   = $ \\[50 pt]
