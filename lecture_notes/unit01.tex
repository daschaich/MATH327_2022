...
For this unit we will focus on some of the foundational mathematics that will underlie our later development and application of statistical ensembles.
...
\begin{mdframed}
  \ \\[100 pt]
\end{mdframed}
You can check your results against those plotted below, which come from \href{https://github.com/daschaich/MATH327_2021/blob/master/lecture_notes/unit01_prob.py}{this python code} that is available for you to peruse, run for different $N$ or modify.
\begin{center}
